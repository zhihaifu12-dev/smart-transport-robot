/**
  ...
  * @brief              小车附体坐标系下XY两方向使用不同的pid参数运动,测试pid参数
  *****************************************************************************
/***主函数，正常使用隐去测试宏定义***/
...
CAR_GOAL_POINT MoveSquence[] =
    {
        ...
        {1500, 0, 0, 400, 2, 200, 2},          // 1扫码
        {1500, 1500, 0, 400, 2, 200, 2},          // 2转盘
        {0, 1500, 0, 400, 2, 200, 2},         // 3退出转盘
        {0, 0, 0, 400, 2, 200, 2},  // 4路口旋转
        {0, 0, M_PI / 2, 400, 2, 200, 2}, // 5十字路口
        {0, 0, M_PI, 400, 2, 200, 2}, // 6进入粗加工区
        {0, 0, M_PI * 1.5, 400, 2, 200, 2},     // 7粗加工中心
        {0, 0, 0, 400, 2, 200, 2}, // 8拐角1
        {0, 0, M_PI * 2, 400, 2, 200, 2},     // 9拐角2 
    }; // 每次移动的距离，基于局部坐标
// 按钮
