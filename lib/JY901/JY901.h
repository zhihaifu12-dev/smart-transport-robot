...
#define WTIMU_RX PD9
#define WTIMU_TX PD8
#define WTIMU_BAUDRATE 115200 //陀螺仪波特率

//IMU指令
extern unsigned char Unlock[5];      //寄存器解锁指令
extern unsigned char resetZAngle[5];// Z轴角度复位指令
extern unsigned char Save[5];        // Z轴角度复位指令
...
{
  public: 
	uint32_t angleUpdateCount = 0; // 每收到一帧0x53角度数据递增，用于过滤重复旧数据
...
extern CJY901 JY901;
extern HardwareSerial Serial_WTIMU;
void IMU_Init();
#endif
